...
While the use of use of metamodels to describe the structure of DSMLs is well established, the lack of appropriate formalisms for defining its semantics is identified as a barrier to the automatic generation of tools \cite{ChallengesSemantics}.
