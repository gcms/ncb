...
Under the implemented execution environment, the \emph{Broker Manager} is the main element of the execution environment and is the responsible for controlling the flow of execution.
...
Most of the work related to model-driven development of execution engines for DSMLs is directly associated to the definition of DSML dynamic semantics. (maybe mention the need of formalized semantics to generate tools [Challenges and Directions in Formalizing the Semantics of Modeling Languages])
