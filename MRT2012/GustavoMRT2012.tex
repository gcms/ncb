...
Metamodels can be employed to describe the abstract syntax and static semantics of a language. Moreover, MDE tools often provide support for the construction of concrete syntax and their mapping to a metamodel.

dynamic semantics is defined by either transformation/interpreter, and the process is called semantic mapping

- usually built from code or using general-purpose transforming languages
