...
Therefore, we envision an approach to generalize the construction of this category of execution engines, that are targeted at the processing of DSMLs related to the provision of services upon a set of resources and capable of transparently executing models created or changed at runtime.
...
We propose the integration of the meta-model of a DSML to a model that describes its execution engine as a way to create platforms for the development of applications by using high-level models that can be created and changed at runtime.
...
We expect that by extending the use of MDE techniques to the definition of execution engines we could not only simplify the construction of execution engines, but also make it easier to evolve them to support changes in their DSML or in the implementation platform. The ability to manipulate the execution engine also enables the modification of the behavior...
