...
Models are usually described in domain-specific modeling languages \cite{Schmidt, Kurtev:2006:MDF:1176617.1176632}, and processed by automated tools into constructs of the implementation platform. 
A DSML, as any other language is defined by its syntax and semantics. A language can be describe by ...

MDE principles and tools provides support for building DSMLs\cite{Kurtev:2006:MDF:1176617.1176632}, ... provides tools for defining abstract syntax/static semantics and a systematic approach for defining the dynamics (still lack standard)

Due to its potential, MDE techiques have been proposed as a way to deal with the growing complexity of contemporary software\cite{}.
