...
public class NCBPolicy implements Comparable{
	...
	public NCBPolicy (Scope scope, Condition condition, BusinessValue bvalue, Decision decision, String type,String name)
	{
		pScope=scope;
	...
	public  int compareTo(Object anotherPolicy)
	{
		...
		int theOtherIntVar = Integer.parseInt(((NCBPolicy)anotherPolicy).getBValue().getValue());
