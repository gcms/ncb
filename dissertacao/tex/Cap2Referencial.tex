...
Sob essa ótica, o princípio básico da engenharia de modelos propõe do uso de modelos como objetos de primeira classe, utilizados na construção de todos os artefatos de software \cite{Unifying}.
...
A abordagem de engenharia dirigida por modelos fornece um conjunto de princípios e ferramentas para construção de linguagens de modelagem, que se adequam perfeitamente à construção de DSLs \cite{Kurtev:2006:MDF:1176617.1176632, ts}.
