...
\chapter{Modelagem de um Intermediador de Comunicação}
\label{cap:instancia}
...
Ao longo das subseções seguintes, os modelos são descritos por meio de uma notação para descrição de modelos de forma textual e compreensível. Essa notação, denominada \emph{Human Usable Textual Notation} (HUTN) \cite{hutn} é padronizada pela OMG, e apresenta vantagens na descrição de modelos mais detalhados, cuja representação gráfica pode exigir muito espaço.
