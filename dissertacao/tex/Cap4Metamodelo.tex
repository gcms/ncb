...
No metamodelo proposto, a definição de um intermediador de serviços se dá pela descrição de como este deve se comportar em resposta a cada uma das possíveis solicitações que podem advir da camada superior, e dos eventos que podem ser gerados pelos recursos gerenciados. Esta abordagem se baseia em uma arquitetura dirigida por eventos \cite{eda}, onde o comportamento é determinado pela forma como os eventos são tratados. Neste trabalho, utilizamos o termo \emph{sinal} para designar de forma generalizada um evento. Assim, um sinal pode representar tanto uma solicitação recebida quanto um evento gerado.
