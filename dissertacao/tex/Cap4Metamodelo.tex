...
\begin{figure}
 \centering
 \includegraphics[width=1\textwidth]{./fig/sinais}
...
\begin{figure}
 \centering
 \includegraphics[width=0.85\textwidth]{./fig/resource}
...
Muitas vezes, o processamento de um determinado sinal pela camada de intermediação de serviços pode depender de fatores que não estão diretamente ao sinal.
...
\begin{figure}
 \centering
 \includegraphics[width=0.45\textwidth]{./fig/state}
...
\begin{figure}
 \centering
 \includegraphics[width=0.65\textwidth]{./fig/autonomo}
...
A classe \textsf{Policy} representa uma política, que é definida por meio de um nome e uma condição a ser avaliada sobre um recurso. Além disso, uma política define um valor de negócio associado ao cumprimento da condição pelo recurso. Durante a execução da camada a seleção de recursos se baseia no valor de negócio acumulado na avaliação das políticas.

PolicyContext define o contexto, i.e. conjunto de parametros, necessário para avaliação das políticas.
...
Um tratador de avaliação de políticas, representado por meio da classe \textsf{PolicyEvaluationHandler}, define a ação a ser tomada sobre os resultados da avaliação de políticas. Um ponto de avaliação de políticas é associado à um tratador de avaliação de políticas por meio de uma requisição de avaliação de políticas. Uma requisição de avaliação de políticas, definida por meio da classe \textsf{PolicyEvaluationRequest}, estabelece o mapeamento entre o contexto do sinal que inicia a avaliação de políticas e o necessário para a avaliação em si.
