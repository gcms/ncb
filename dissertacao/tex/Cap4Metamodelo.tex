...
No metamodelo proposto, a interface para utilização de um gerenciador de intermediação é definida por meio de \emph{chamadas} que podem ser realizadas ao gerenciador e \emph{eventos} que podem ser sinalizados pelo mesmo. 
