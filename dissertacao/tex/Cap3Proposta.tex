...
Desta forma, o metamodelo e o ambiente de execução construídos possibilitam que intermediadores de serviços sejam descritos por meio de modelos e utilizados em tempo de execução pela camada de \emph{middleware}.
