...
Desta forma, o metamodelo e o ambiente de execução construídos posssibilitam que intermediadores de serviços possam ser descritos por meio de modelos e utilizados em tempo de execução pela camada de \emph{middleware}.
Os capítulos seguintes apresentam na seguinte ordem o metamodelo elaborado para a definição de intermediadores de serviços; o ambiente de execução capaz de processar os modelos descritos por meio do metamodelo; e um modelo criado a partir desse metamodelo que descreve uma camada com comportamento equivalente à camada NCB que integra a CVM.
