...
\autor{Gustavo Cipriano Mota Sousa} % (José da Silva)
\autorR{Sousa, Gustavo Cipriano Mota} % (da Silva, José)

\titulo{Desenvolvimento de Máquinas de Execução para Linguagens de Modelagem Específicas de Domínio: Uma Estratégia Baseada em Engenharia Dirigida por Modelos}
%\subtitulo{\textless Subtítulo do Trabalho\textgreater}

\cidade{Goiânia} % Nome da cidade em foi desenvolvido o trabalho
\dia{09} %
\mes{10} % Data da apresentação/defesa do trabalho
\ano{2012} % Formato numérico: \dia{01}, \mes{01} e \ano{2009}

%-------------------------------------------------------------- ORIENTADOR %
\orientador{Fábio Moreira Costa}
\orientadorR{Costa, Fábio Moreira}
...
%--------------------------------------------------------------- CAPÍTULOS %
\input{./tex/Cap1Introducao}
\input{./tex/Cap2Referencial}
\input{./tex/Cap3Proposta}
\input{./tex/Cap4Metamodelo}
\input{./tex/Cap5Ambiente}
\input{./tex/Cap6Instancia}
\input{./tex/TrabalhosRelacionados}
\input{./tex/Cap7Conclusoes}
